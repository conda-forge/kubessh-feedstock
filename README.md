...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kubessh-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11102&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kubessh-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `kubessh` can be installed with:

```
conda install kubessh
```

It is possible to list all of the versions of `kubessh` available on your platform with:
